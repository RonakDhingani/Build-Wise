...
extension ExpenseCategoryModelByIndex on IsarCollection<ExpenseCategoryModel> {
  Future<ExpenseCategoryModel?> getByName(String name) {
    return getByIndex(r'name', [name]);
  }

  ExpenseCategoryModel? getByNameSync(String name) {
  ...
  Future<List<ExpenseCategoryModel?>> getAllByName(List<String> nameValues) {
    final values = nameValues.map((e) => [e]).toList();
    return getAllByIndex(r'name', values);
  }

  List<ExpenseCategoryModel?> getAllByNameSync(List<String> nameValues) {
    final values = nameValues.map((e) => [e]).toList();
  ...
  Future<Id> putByName(ExpenseCategoryModel object) {
    return putByIndex(r'name', object);
  }

  Id putByNameSync(ExpenseCategoryModel object, {bool saveLinks = true}) {
    return putByIndexSync(r'name', object, saveLinks: saveLinks);
  }

  Future<List<Id>> putAllByName(List<ExpenseCategoryModel> objects) {
    return putAllByIndex(r'name', objects);
  }

  List<Id> putAllByNameSync(List<ExpenseCategoryModel> objects,
      {bool saveLinks = true}) {
...
extension ExpenseCategoryModelQueryFilter on QueryBuilder<ExpenseCategoryModel,
  ...
  QueryBuilder<ExpenseCategoryModel, ExpenseCategoryModel,
      QAfterFilterCondition> iconNameIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
        property: r'iconName',
      ));
  ...
  QueryBuilder<ExpenseCategoryModel, ExpenseCategoryModel,
      QAfterFilterCondition> iconNameIsNotNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNotNull(
        property: r'iconName',
      ));
...
extension ExpenseCategoryModelQueryProperty on QueryBuilder<
  ...
  QueryBuilder<ExpenseCategoryModel, DateTime, QQueryOperations>
      createdAtProperty() {
    return QueryBuilder.apply(this, (query) {
